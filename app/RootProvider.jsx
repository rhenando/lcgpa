...
function AppLayout({ children }) {
  ...
  // This matches "/en/about-us", "/ar/about-us", etc.
  const isAboutUs = pathname?.split("/").pop() === "about-us";
  ...
  return (
    <>
      {/* Header/StickyBar hidden ONLY for /about-us */}
      {!isAboutUs && (
      ...
      {/* Footer hidden ONLY for /about-us */}
      {!isAboutUs && <Footer />}
