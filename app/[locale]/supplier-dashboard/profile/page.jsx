...
export default function ManageProfilePage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (snap.exists()) {
        ...
        data.companyProfileUrl = data.companyProfileUrl || "";
        setFormData(data);
      }
      setLoading(false);
    })();
  ...
  const PreviewOrLink = ({ url, alt, field }) => {
    if (!url) return null;
    // Always treat these fields as PDFs!
    if (["companyProfileUrl", "crLicenseUrl"].includes(field)) {
      return (
        <div className='mb-2'>
